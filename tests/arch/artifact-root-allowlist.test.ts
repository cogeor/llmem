...
const ALLOWLIST: readonly AllowlistEntry[] = [
    ...
    { file: 'tests/arch/logger-ownership.test.ts',
      phase: 'permanent',
      reason: 'K3 Logger name-ownership scanner; literal lives in its SKIP_DIRS set.' },
    ...
    { file: 'tests/unit/graph/edge-store-transaction.test.ts',
      phase: 'permanent',
      reason: 'Fixture artifact dir for the edge-store withTransaction lost-update + no-deadlock unit tests (K2).' },
