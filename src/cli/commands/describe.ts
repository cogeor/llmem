...
// type inference from blowing up `compile:vscode` against zod-to-json-schema.
// eslint-disable-next-line @typescript-eslint/no-var-requires, @typescript-eslint/no-require-imports
const { zodToJsonSchema } = require('zod-to-json-schema');

// Repo-root package.json. esbuild inlines this JSON require at build time,
// resolving it relative to this source file — `../../../package.json` from
// src/cli/commands/ reaches the repo root.
// eslint-disable-next-line @typescript-eslint/no-var-requires, @typescript-eslint/no-require-imports
