...
import { DESIGN_TEXT_VIEW_STYLES } from './DesignTextViewStyles';
...
export class DesignTextView {
    ...
    constructor({ el, state, dataProvider, logger }: DesignTextViewProps) {
        ...
        // safe: DESIGN_TEXT_VIEW_STYLES is an author-controlled static string
        // literal defined in DesignTextViewStyles.ts; no interpolation,
        // no user data.
        this.shadow.innerHTML = DESIGN_TEXT_VIEW_STYLES;
